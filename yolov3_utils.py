...
# classes YOLOv3 rknn network has been trained on
#
...
def draw_image_boxes(image, boxes, scores, classes):
...
def label_result_img(outputs, image, rknn_model, im_file) :
	...
	if boxes is not None: draw_image_boxes(image, boxes, scores, classes)

	fname = im_file + '_result.jpg'
	print('Save results to ', fname)
	cv2.imwrite(fname, image)

	return boxes, classes, scores

	
def label_cv2_img(outputs, image) :
